...
class User {
 ...
 private    $Tokens = "{}";
    ...
    $this->Tokens=htmlspecialchars(strip_tags($this->Tokens));
   ...
   function emailExists(){
    ...
    $query = "SELECT id, firstname, lastname, password,Tokens
...
public function update(){
   ...
   $this->password=htmlspecialchars(strip_tags($this->Tokens));
